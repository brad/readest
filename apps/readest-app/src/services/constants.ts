...
import { DEFAULT_SENTENCE_GAP_SEC } from './tts/BufferedTTSClient';
import { DEFAULT_PARAGRAPH_GAP_SEC } from './tts/BufferedTTSClient';
...
export const DEFAULT_GEMINI_MODEL = 'gemini-3.1-flash-tts-preview';
